...
SRC = ./src/Server/cmd/CAP.cpp ./src/Server/cmd/USER.cpp ./src/Server/cmd/PING.cpp ./src/Server/cmd/JOIN.cpp ./src/Server/cmd/NICK.cpp ./src/Server/cmd/PASS.cpp ./src/Server/cmd/PRIVMSG.cpp ./src/Server/cmd/QUIT.cpp ./src/Server/parser.cpp ./src/Server/Server.cpp ./src/Server/exec.cpp ./src/Server/utils.cpp ./src/Channel/Channel.cpp ./src/Numerics/_461_ERR_NEEDMOREPARAMS.cpp ./src/Numerics/_421_ERR_UNKNOWNCOMMAND.cpp ./src/Numerics/_464_ERR_PASSWDMISMATCH.cpp ./src/Numerics/_001_RPL_WELCOME.cpp ./src/Numerics/_332_RPL_TOPIC.cpp ./src/Numerics/_353_RPL_NAMREPLY.cpp ./src/Numerics/_366_RPL_ENDOFNAMES.cpp ./src/Numerics/_401_ERR_NOSUCHNICK.cpp ./src/Numerics/_403_ERR_NOSUCHCHANNEL.cpp ./src/Numerics/_404_ERR_CANNOTSENDTOCHAN.cpp ./src/Numerics/_405_ERR_TOOMANYCHANNELS.cpp ./src/Numerics/_412_ERR_NOTEXTTOSEND.cpp ./src/Numerics/_475_ERR_BADCHANNELKEY.cpp ./src/Numerics/_432_ERR_ERRONEUSNICKNAME.cpp ./src/Numerics/_433_ERR_NICKNAMEINUSE.cpp ./src/User/User.cpp ./main.cpp 
